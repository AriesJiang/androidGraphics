...
public final class Palette {
    ...
    private final Bitmap mBitmapScale;

    Palette(List<Swatch> swatches, List<Target> targets, Bitmap bitmapScale) {
        mSwatches = swatches;
        mTargets = targets;
    ...
    public static final class Swatch {
        ...
        public double distanceOf(int red, int green, int blue) {
//            int r = Math.abs(red - mRed) + 1;
//            int g = Math.abs(green - mGreen) + 1;
//            int b = Math.abs(blue - mBlue) + 1;
//            return r * g * b;
            int r = Math.abs(red - mRed);
            int g = Math.abs(green - mGreen);
            int b = Math.abs(blue - mBlue);
            return r + g + b;
        }
...
//            mFilters.add(DEFAULT_FILTER);
        ...
        @NonNull
        public Builder resizeBitmapWHSize(final int size) {
            resizeBitmapArea(size * size);
            return this;
        }
        ...
        public Palette generate() {
            ...
            if (mBitmap != null) {
                ...
                bitmap = scaleBitmapDown(mBitmap);
...
//                }
            ...
            final Palette p = new Palette(swatches, mTargets, bitmap);
